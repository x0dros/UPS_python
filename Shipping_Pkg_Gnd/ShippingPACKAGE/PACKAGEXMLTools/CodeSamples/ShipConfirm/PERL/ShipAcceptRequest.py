...
class ShipmentAcceptRequest(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ShipmentAcceptRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ShipmentAcceptRequest.subclass:
            return ShipmentAcceptRequest.subclass(*args_, **kwargs_)
        else:
            return ShipmentAcceptRequest(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ShipmentAcceptRequest', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ShipmentAcceptRequest')
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ShipmentAcceptRequest')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ShipmentAcceptRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ShipmentAcceptRequest'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ShipmentAcceptRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ShipmentDigest is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ShipmentDigest>%s</ShipmentDigest>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ShipmentDigest), input_name='ShipmentDigest')), eol_))
    def build(self, node):
        already_processed = set()
...
# end class ShipmentAcceptRequest
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        ...
        rootClass = ShipmentAcceptRequest
